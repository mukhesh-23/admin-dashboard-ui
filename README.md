...
This project is a frontend Admin Dashboard UI built using **React, TypeScript, and Tailwind CSS**.  
The project focuses on converting selected components from a Figma design into **clean, reusable, and pixel-accurate React components**.
...
This helped me understand the layout structure, spacing, colors, typography, and assets.
...
This helped in keeping the code clean, modular, and easy to maintain.
...
The focus was always on UI accuracy and clarity, not on adding unnecessary features.
...
Tailwind CSS helped in maintaining a clean and consistent UI.

The focus was kept on UI accuracy rather than building a full dashboard.

Time Taken
Design analysis & planning: ~1–2 hours

Component development & styling: ~6–7 hours

Refinement & deployment: ~1–2 hours
